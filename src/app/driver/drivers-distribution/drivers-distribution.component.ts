...
@Component({
  selector: 'app-drivers-distribution',
  templateUrl: './drivers-distribution.component.html',
  styleUrls: ['./drivers-distribution.component.css']
})
export class DriversDistributionComponent implements OnInit {
  ...
  private getLocationAddress(params: HttpParams): Observable<any> {
    return this.driverService.getLocationDetails(params)
  }
